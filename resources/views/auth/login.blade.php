      ...
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password"
                      ...
                      name="password" required autocomplete="current-password" id="exampleInputPassword"
          ...
          <div class="col-lg-6 login-half-bg d-flex flex-row">
            <p class="text-white font-weight-medium text-center flex-grow align-self-end">Copyright &copy; 2022 All
              rights reserved.</p>
          </div>
        </div>
      </div>
